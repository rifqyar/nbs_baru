...
class NotaDeliveryService
{
    ...
    function printProforma($req)
    {
       ...
       WHERE a.ID_NOTA = '$notanya' AND a.KETERANGAN ='MATERAI' ";
        ...
        $query_dtl  = "SELECT * from (SELECT a.JML_HARI,
                                ...
                                b.TYPE_,
                                b.STATUS
                        FROM nota_delivery_d@DBCLOUD_LINK a, iso_code@DBCLOUD_LINK b
                        WHERE
                        a.id_iso = b.id_iso
    ...
    function printNota($request)
    {
        ...
        $query_tgl    = "SELECT TO_CHAR(TGL_REQUEST,'dd/mon/yyyy') TGL_REQUEST FROM request_delivery@DBCLOUD_LINK
        ...
        $jum          = "SELECT COUNT(NO_CONTAINER) JUMLAH FROM container_stuffing@DBCLOUD_LINK  WHERE no_request = '$no_req'";
