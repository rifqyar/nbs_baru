...
class BatalReceivingService
{
    ...
    function batalReceivingCont($request)
    {
        ...
        try {
            ...
            $rw_gate = DB::connection('uster')->select($cek_gati);

            if ($rw_gate["NO_CONTAINER"] != NULL) {
                echo ("<script>alert('sudah_gate')</script>");
                exit();
            }
            ...
            $rw_getcounter = DB::connection('uster')->select($q_getcounter);
            ...
            if ($location == 'GATO') {
                ...
                if (DB::connection('uster')->statement($rbatal)) {
                    ...
                    if (DB::connection('uster')->statement($qhist)) {
                        ...
                        $rwl = DB::connection('uster')->select($lasthist);
