    ...
    function getNoContainer($no_cont)
    {
        ...
        $query             = "SELECT DISTINCT a.NO_CONTAINER,
                   ...
                   -- AND B.STATUS_CONT = 'MTY'
                    and b.kegiatan IN ('REALISASI STRIPPING','GATE IN','BATAL STUFFING','BATAL RECEIVING','REQUEST BATALMUAT','REQUEST DELIVERY', 'BORDER GATE IN', 'BATAL STRIPPING', 'PERPANJANGAN STRIPPING', 'REALISASI STUFFING')
					--UNION
