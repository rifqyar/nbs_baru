            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="display nowrap table datatables-service table" cellspacing="0" width="100%"  id="service-table">
                            <thead>
                                <tr>
                                    <th>NO</th>
                                    <th>NO. REQUEST</th>
    ...
    <script>
        $(document).ready(function() {
            $('#service-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{!! route('uster.billing.nota_batalmuat.datatable') !!}',
                    type: 'GET',
                    data: function(d) {
                        d.from = $('#from').val();
                        d.to = $('#to').val();
