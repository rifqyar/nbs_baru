...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor">Nota Receiving</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Billing</a></li>
                <li class="breadcrumb-item">Nota Receiving</li>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="row justify-content-center">
                    <a href="{{route('uster.billing.nota_receiving.insert_proforma', [base64_encode($no_req), 'koreksi='.$koreksi])}}" class="btn btn-outline-info w-50 mb-5 row align-items-center">
