        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="row justify-content-center">
                    <a href="{{route('uster.billing.nota_stripping.insert_proforma_relokmty', [base64_encode($no_req), 'koreksi='.$koreksi])}}" class="btn btn-outline-info w-50 mb-5 row align-items-center">
