    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Cetak Nota Stuffing</li>
            </ol>
        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#service-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{!! route('uster.billing.nota_stuffing.datatable') !!}',
                    type: 'GET',
                    data: function(d) {
                        d.from = $('#from').val();
                        d.to = $('#to').val();
        ...
        function recalc(req, nota) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    var url = "{{ route('uster.billing.nota_stuffing.recalc_stuffing') }}";
                    $.ajaxSetup({
                        headers: {
        ...
        function recalc_pnkn(req, nota) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    var url = "{{ route('uster.billing.nota_stuffing.recalc_stuffing_pnkn') }}";
                    $.ajaxSetup({
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        }
