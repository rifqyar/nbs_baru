...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Batal Container SP2</li>
        </ol>
    </div>
                ...
                <div class="border rounded my-3">
                    <form id="dataCont">
                        ...
                        <div class="p-3">
                            ...
                            <div class="row">
                                <div class="col-md-2 py-2">
                                    <label for="tb-fname">No Request SP2 : </label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" name="NO_REQ" id="NO_REQ" class="form-control" readonly>
                                </div>
                                <div class="col-md-2 py-2">
                                    <label for="tb-fname">Tgl Request SP2 : </label>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-2 py-2">
                                    <label for="tb-fname">Delivery Ke : </label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" id="DELIVERY_KE" name="DELIVERY_KE" class="form-control" readonly>
                                </div>
                                <div class="col-md-2 py-2">
...
<script>
    $(document).ready(function() {
        ...
        $('#NO_CONT').select2({
            ...
            ajax: {
                ...
                url: '{!! route("uster.koreksi.batalsp2.getnocontainer") !!}',
                dataType: 'json',
                processResults: function(data) {
                    ...
                    return {
                        results: arrs.map((arr, i) => ({
                            id: arr.no_container,
                            text: arr.no_container + ' | ' + arr.size_ + ' | ' + arr.type_,
                            ...arr
                        }))
                    };
                }
        ...
        $('#NO_CONT').on('select2:select', function(e) {
            ...
            $("#STRIPPING_DARI").val(data.stripping_dari);
            $("#LUNAS").val(data.lunas);
            $("#NO_REQUEST_RECEIVING").val(data.no_request_receiving);
        })
    });
    ...
    function batal() {
        ...
        $.ajax({
            url: '{!! route("uster.koreksi.batalsp2.batalsp2cont") !!}',
            type: 'POST',
            data: {
                _token: csrfToken,
                NO_CONT: no_cont_,
