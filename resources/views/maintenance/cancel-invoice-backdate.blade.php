    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <h3><b>Cancel Invoice Administrator</b></h3>
                    ...
                    <form action="javascript:void" id="requestGateIn" novalidate>
                        ...
                        <div class="p-3">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" id="NO_NOTA" name="NO_NOTA"
                                        class="suggestuwriter ui-autocomplete-input" type="text" value=""
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 py-3">
                                    <label for="tb-fname">Tanggal Realisasi : </label>
                                </div>
                                <div class="col-md-4">
                                    <input class="form-control" name="TGL_REAL" id="TGL_REAL" type="date"
                                        value="">
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col">
                                    <input class="form-control" id="id_KETERANGAN" name="id_KETERANGAN" type="text"
                                        value="">
                                </div>
...
@section('pages-js')
    <script>
        $(document).ready(function() {
            $('#NO_NOTA').select2({
                ...
                ajax: {
                    ...
                    url: '{!! route('uster.maintenance.getNotaFaktur') !!}',
                    dataType: 'json',
        ...
        function cancel() {
            ...
            var url = '{{ route('uster.maintenance.storeCancelBackdate') }}';
