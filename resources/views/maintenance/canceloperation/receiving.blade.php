...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Batal Container SP2 - Receiving</li>
        </ol>
    </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <h3><b>Batal Container SP2 - Receiving</b></h3>
...
<script>
    $(document).ready(function() {
        ...
        $('#NO_CONT').select2({
            ...
            ajax: {
                ...
                url: '{!! route("uster.maintenance.cancel_operation.receiving.getnocontainer") !!}',
                dataType: 'json',
        ...
        $('#NO_REQUEST').select2({
            ...
            ajax: {
                // Implement your AJAX settings for data retrieval here
                url: '{!! route("uster.maintenance.cancel_operation.receiving.getrequest") !!}',
                dataType: 'json',
                processResults: function(data) {
                    const arrs = data;
                    return {
    ...
    function load_table(noreq, nocont, nobook) {
        ...
        $('#container-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{!! route("uster.maintenance.cancel_operation.receiving.datatable") !!}' + '?NO_CONT=' + nocont + '&NO_REQUEST=' + noreq + '&NO_BOOKING=' + nobook,
                type: 'GET',
                data: function(d) {
                    // d.noReq = $('#NO_REQ').val();
                }
    ...
    function delete_operation() {
        ...
        $.ajax({
            url: '{!! route("uster.maintenance.cancel_operation.receiving.deleteoperation") !!}',
            type: 'POST',
            data: {
                _token: csrfToken,
                NO_CONT: no_cont_,
