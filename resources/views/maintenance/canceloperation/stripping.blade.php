...
<script>
    $(document).ready(function() {
        ...
        $('#NO_CONT').select2({
            ...
            ajax: {
                ...
                url: '{!! route("uster.maintenance.cancel_operation.stripping.getnocontainer") !!}',
                dataType: 'json',
        ...
        $('#NO_REQUEST').select2({
            ...
            ajax: {
                // Implement your AJAX settings for data retrieval here
                url: '{!! route("uster.maintenance.cancel_operation.stripping.getrequest") !!}',
                dataType: 'json',
                processResults: function(data) {
                    const arrs = data;
                    return {
    ...
    function load_table(noreq, nocont, nobook) {
        ...
        $('#container-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{!! route("uster.maintenance.cancel_operation.stripping.datatable") !!}' + '?NO_CONT=' + nocont + '&NO_REQUEST=' + noreq + '&NO_BOOKING=' + nobook,
                type: 'GET',
                data: function(d) {
                    // d.noReq = $('#NO_REQ').val();
                }
    ...
    function delete_operation() {
        ...
        $.ajax({
            url: '{!! route("uster.maintenance.cancel_operation.stripping.deleteoperation") !!}',
            type: 'POST',
            data: {
                _token: csrfToken,
                NO_CONT: no_cont_,
