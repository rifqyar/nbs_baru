...
@section('title')
    Gate Administrator (Gate Out Container Ke TPK)
@endsection
...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor">Gate Administrator (Gate Out Container Ke TPK)</h3>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="javascript:void(0)" id="form-data" class="m-t-40">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="tgl_gato" class="form-label">Tgl. Gate Out</label>
                                        <input type="text" class="form-control" id="tgl_gato" name="tgl_gato"
                                            required>
                                    </div>
                                </div>
                                <div class="row">
...
@section('pages-js')
    <script>
        ...
        function gateOut() {
            Swal.fire({
                title: "Insert Data",
                text: "Apakah Anda yakin ingin insert data gate out?",
                type: "question",
