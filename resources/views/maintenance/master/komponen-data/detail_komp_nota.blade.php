    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <h3><b>Detail Komponen {{ $notaa->nama_nota }}</b></h3>
                            ...
                            <tbody>
                                @foreach ($row_list as $item)
                                    <tr>
                                        <td>{{ $loop->index + 1 }} </td>
                                        <td>
                                            <b>{{ $item->id_komp_nota }}</b>
                                        </td>
                                        <td>{{ $item->komponen_nota }}</td>
                                        <td>{{ $item->status }}</td>
                                        <td>
                                            <a href="{{ route('uster.maintenance.master_komp_tarif.edit') }}?id_nota={{ $item->id_nota }}&komp_nota={{ $item->id_komp_nota }}"
