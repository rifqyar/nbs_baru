                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="col-12 col-md-12">
                                            <div class="form-group m-b-40">
                                                ...
                                                <input type="text" class="form-control" name="no_npwp" style="text-transform:uppercase" id="no_npwp">
                                                <span class="bar"></span>
                                            </div>
                                        </div>
        ...
        if (this.checkValidity()) {
            ...
            table.ajax.reload(function () {
                ...
                if (data.data && data.data.length > 0) {
                    input_success({ status: 200, message: "Data ditemukan!" });
                } else {
                    input_error({ message: "Nomor NPWP belum terdaftar di pconect" });
                }
            });
        }
