                    ...
                    <form action="javascript:void" id="requestGateIn" novalidate>
                        ...
                        <div class="p-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input id="NO_REQ" name="NO_REQ" class="form-control" type="text" readonly>
                                </div>
                                <div class="col-md-2 py-3">
...
@section('pages-js')
    <script>
        $(document).ready(function() {
            $('#CONT_NO').select2({
                ...
                ajax: {
                    ...
                    url: '{!! route('uster.operation.gate.gate_in.getContainer') !!}',
                    dataType: 'json',
        ...
        $('#requestGateIn').on('submit', function(e) {
        ...
        function saveEditData() {
            var form = $('#requestGateIn').serialize()
