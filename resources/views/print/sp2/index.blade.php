...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor">Cetak Kartu SP2</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Print</li>
                <li class="breadcrumb-item active">Cetak Kartu SP2</li>
            </ol>
        </div>
...
@push('after-script')
    ...
    <script src="{{ asset('pages/print/sp2.js') }}"></script>
@endpush
