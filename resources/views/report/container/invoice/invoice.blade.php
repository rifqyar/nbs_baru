...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Laporan Container By Invoice</li>
        </ol>
    </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <h3><b>Laporan Container By Invoice</b></h3>
                    ...
                    <form id="dataCont">
                        ...
                        <div class="p-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input id="NO_REQUEST" name="NO_REQUEST" type="text" class="form-control" readonly />
                                    <input id="KEGIATAN" name="KEGIATAN" type="text" class="form-control" readonly />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" type="text" name="NM_PBM" id="NM_PBM" readonly />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2 py-2">
                                    <label for="tb-fname">Total Tagihan: </label>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-2 py-2">
                                    <label for="tb-fname">PPN: </label>
                                </div>
                                <div class="col-md-4">
                                    <input class="form-control" type="text" name="PPN" id="PPN" readonly />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2 py-2">
                                    <label for="tb-fname">Jumlah yang dibayar: </label>
                                </div>
                                <div class="col-md-4">
                                    <input class="form-control" type="text" name="TOTAL_TAGIHAN" id="TOTAL_TAGIHAN" readonly />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2 py-2">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" type="text" name="LUNAS" id="LUNAS" readonly />
                                </div>
                            </div>
                        </div>
                    </form>
...
<script>
    $(document).ready(function() {
        ...
        $('#NO_NOTA').select2({
            ...
            ajax: {
                ...
                url: '{!! route("uster.report.container.invoice.nota") !!}',
                dataType: 'json',
    ...
    function genReport() {
        ...
        $('#container-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{!! route("uster.report.container.invoice.datatable") !!}',
                type: 'POST',
                headers: {
    ...
    function toExcel() {
        ...
        var request = $("#NO_REQUEST").val();
        var kegiatan = $("#KEGIATAN").val();
        var url = '{!! route("uster.report.container.invoice.generateexcel") !!}?NO_NOTA=' + nota + "&NO_REQUEST=" + request + "&KEGIATAN=" + kegiatan;
    ...
    function toPdf() {
        ...
        var url = '{!! route("uster.report.container.invoice.generatepdf") !!}?tgl_awal=' + tgl_awal_ + "&tgl_akhir=" + tgl_akhir_;
