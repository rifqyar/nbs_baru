            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="border rounded my-3">
                        ...
                        <button onclick="genReport()" class="btn btn-danger mr-2"><i class="fas fa-file-alt pr-2"></i>
                            Generate Report</button>
                        <button onclick="toExcel()" class="btn excel-button"><i class="fas fa-file-excel pr-2"></i> Generate
                            Excel</button>
                    </div>
                    <div class="card p-2">
...
@section('pages-js')
    ...
    <script>
        ...
        function toExcel() {
            ...
            var voyage = $("#VOYAGE").val();
            var status_ = $("#STATUS").val();
            var url = '{!! route('uster.report.deliveryperkapal.generateexcel') !!}?nm_kapal=' + nm_kapal + "&voyage=" + voyage + "&status=" + status_;
