                        ...
                        <form id="dataCont">
                            ...
                            <div class="p-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="JN_REPO" id="JN_REPO" class="form-control"
                                            value="{{ $data['row_request']->jn_repo }}" readonly>
                                    </div>
                                    <div class="col-md-2 py-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input type="text" name="NO_REQUEST" id="NO_REQUEST" class="form-control"
                                                    value="{{ $data['row_request']->no_request }}">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" name="NO_REQUEST2" id="NO_REQUEST2"
                                                    class="form-control" value="{{ $data['no_req2'] }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-4" style="display:none">
                                        <input class="form-control" id="KD_PELANGGAN" name="KD_PELANGGAN" type="hidden"
                                            value="{{ $data['row_request']->kd_pbm }}" readonly />
                                        <input class="form-control" id="NPWP" name="NPWP" type="hidden"
                                            value="{{ $data['row_request']->no_npwp_pbm ?? '' }}" readonly />
                                        <input class="form-control" id="ALAMAT" name="ALAMAT" type="hidden"
                                            value="{{ $data['row_request']->alamat ?? '' }}" readonly />
                                        ...
                                        <select name="NM_PELANGGAN" id="NM_PELANGGAN" class="form-control w-100">
                                            <option value="{{ $data['row_request']->nama_pbm }}" selected>
                                                {{ $data['row_request']->nama_pbm }} </option>
                                        </select>
                                    </div>
                                    <div class="col-md-2 py-2">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" id="KD_PELANGGAN2" name="KD_PELANGGAN2" type="hidden"
                                            value="{{ $data['row_request']->kd_pbm2 }}" readonly />
                                        ...
                                        <select name="NM_PELANGGAN2" id="NM_PELANGGAN2" class="form-control w-100">
                                            <option value="{{ $data['row_request']->nama_pbm2 }}" selected>
                                                {{ $data['row_request']->nama_pbm2 }} </option>
                                        </select>
                                    </div>
                                    <div class="col-md-2 py-2">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" id="id_NO_PEB" name="NO_PEB" type="text"
                                            value="{{ $data['row_request']->peb }}" />
                                        <input class="form-control" id="id_KD_CABANG" name="KD_CABANG" type="hidden"
                                            value="{{ $data['kd_cbg'] }}" /></td>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" id="id_NO_NPE" name="NO_NPE" type="text"
                                            value="{{ $data['row_request']->npe }}" /></td>
                                    </div>
                                    <div class="col-md-2 py-2">
                                        <label for="tb-fname">No RO : </label>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="text" id="NO_RO" name="NO_RO" class="form-control"
                                            value="{{ $data['row_request']->no_ro }}">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" id="KD_KAPAL" name="KD_KAPAL" type="hidden"
                                            value="{{ $data['row_request']->kd_kapal }}" />
                                        <select name="NM_KAPAL" id="NM_KAPAL" class="form-control w-100">
                                            <option value="{{ $data['row_request']->nm_kapal }}" selected>
                                                {{ $data['row_request']->nm_kapal }} </option>
                                        </select>
                                        <input class="form-control" id="CALL_SIGN" name="CALL_SIGN" type="hidden"
                                            value="{{ $data['row_request']->call_sign ?? '' }}" />
                                    </div>
                                    <div class="col-md-2 py-2">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input class="form-control" id="VOYAGE_IN" name="VOYAGE_IN"
                                                    type="text" value="{{ $data['row_request']->voyage_in }}"
                                                    readonly />
                                            </div>
                                            <div class="col-md-6">
                                                <input class="form-control" id="VOYAGE" name="VOYAGE" type="text"
                                                    value="{{ $data['row_request']->voyage }}" readonly />
                                            </div>
                                        </div>
                                        <input class="form-control" id="VOYAGE_OUT" name="VOYAGE_OUT" type="hidden"
                                            value="{{ $data['row_request']->voyage_out }}" readonly />
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" value="{{ $data['row_request']->tgl_berangkat }}"
                                            id="ETD" name="ETD" type="text" readonly />
                                    </div>
                                    <div class="col-md-2 py-2">
                                        <label for="tb-fname">ETA : </label>
                                    </div>
                                    <div class="col-md-4">
                                        <input class="form-control" value="{{ $data['row_request']->tgl_tiba }}"
                                            id="ETA" name="ETA" type="text" readonly />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" id="KD_AGEN" name="KD_AGEN" type="hidden"
                                            value="{{ $data['row_request']->kd_agen }}" readonly />
                                        <input class="form-control" id="TGL_BERANGKAT" name="TGL_BERANGKAT"
                                            type="hidden" value="{{ $data['row_request']->tgl_berangkat }}" readonly />
                                        <input class="form-control" id="NM_AGEN" name="NM_AGEN" type="text"
                                            value="{{ $data['row_request']->nm_agen }}" readonly />
                                    </div>
                                    <div class="col-md-2 py-2">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" id="NO_UKK" name="NO_UKK" type="text"
                                            value="{{ $data['row_request']->no_ukk }}" readonly maxlength="16"
                                            title="Autocomplete" class="pkkkapal" />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" id="NO_BOOKING" name="NO_BOOKING" type="text"
                                            value="{{ $data['row_request']->no_booking }}" maxlength="16" readonly />
                                    </div>
                                    <div class="col-md-2 py-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" id="KD_PELABUHAN_TUJUAN" name="KD_PELABUHAN_TUJUAN"
                                            type="hidden" value="{{ $data['row_request']->kd_pelabuhan_tujuan }}"
                                            readonly />
                                        <input class="form-control" id="POD" name="POD" type="hidden"
                                            value="{{ $data['row_request']->kd_pelabuhan_asal }}" readonly />
                                        <select name="NM_PELABUHAN_TUJUAN" id="NM_PELABUHAN_TUJUAN"
                                            class="form-control w-100">
                                            <option value="{{ $data['row_request']->nm_pelabuhan_tujuan ?? '' }}"
                                                selected> {{ $data['row_request']->nm_pelabuhan_tujuan ?? '' }} </option>
                                        </select>
                                    </div>
                                    <div class="col-md-2 py-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" id="id_SHIFT_RFR" name="SHIFT_RFR" type="text"
                                            value="2" /><b>* Shift</b>
                                    </div>
                                    <div class="col-md-2 py-2">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" id="TGL_STACKING" name="TGL_STACKING" type="hidden"
                                            value="{{ $data['row_request']->tgl_stacking }}" />
                                        <input class="form-control" id="TGL_MUAT" name="TGL_MUAT" type="hidden"
                                            value="{{ $data['row_request']->tgl_muat }}" />
                                        <div class="row">
                                            <div class="col-md-5">
                    ...
                    <div class="border rounded my-3">
                        <div class="p-3">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" class="form-control" type="text" name="SIZE"
                                        id="SIZE" readonly="readonly" />
                                    <input class="form-control" type="hidden" name="TGL_STACK" id="TGL_STACK"
                                        readonly="readonly" />
                                    <input class="form-control" type="hidden" name="ASAL" id="ASAL"
                                        readonly="readonly" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col-4">
                                            <select class="form-control" name="HZ" id="HZ"
                                                onchange="check_hz()">
                                                <option value="N">T</option>
                                                <option value="Y">Y</option>
                                            </select>
                                        </div>
                                        <div class="col-4"><input class="form-control" type="text" id="imo"
                                                name="imo" disabled /></div>
                                        <div class="col-4"><input class="form-control" type="text" id="unnumber"
                                                name="unnumber" disabled /></div>
                                    </div>
                                </div>
                                <div class="col-md-2 py-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" type="text" readonly="readonly" name="TGL_STACK2"
                                        ID="TGL_STACK2" />
                                </div>
                                <div class="col-md-2 py-2">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" type="text" readonly="readonly" name="END_STACK"
                                        ID="END_STACK" />
                                </div>
                            </div>
                            <div class="row">
    ...
    <script>
        $(document).ready(function() {
                ...
                ajax: {
                    ...
                    processResults: function(data) {
                        ...
                        return {
                            results: arrs.map((arr, i) => ({
                                id: arr.no_container,
                                text: arr.no_container + ' | ' + arr.status + ' | ' + arr
                                    .size_ + ' | ' + arr.type_,
                                ...arr
                            }))
                        };
            ...
            contDataTable = $('#container-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{!! route('uster.new_request.delivery.delivery_ke_luar_tpk.editcontlist') !!}' + '?no_req=' + '{!! $data['row_request']->no_request !!}' + "&no_req2=" +
                        '{!! $data['no_req2'] !!}',
                    type: 'GET',
                    data: function(d) {
                        d.noReq = $('#NO_REQ').val();
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            return '<button value="Hapus" onclick="del_cont(\'' + data[
                                    'no_container'] + '\',\'' + data['ex_bp_id'] + '\',' + meta
                                .row + ')" class="btn btn-danger"> Hapus </button>';
                        }
                    },
                ],
                rowCallback: function(row, data, rowIdx) {
                    // Add hidden input field to each row
                    $(row).append('<input type="hidden" id="NO_CONT_' + rowIdx +
                ...
                initComplete: function() {
                    ...
                    $('#button_save').html('<button type="button" onclick="save_tgl_delivery(' +
                        totalRows + ')" value="Save" class="btn btn-info">Save</button>');
                }
            });
                                ...
                                if (carrier_ == '') {
                                    ...
                                    $.ajax({
                                        ...
                                        error: function(xhr, status, error) {
                                            Swal.close();
                                            sAlert('Gagal!', 'Terjadi kesalahan saat mengirim data',
                                                'error');
                                        },
                                        complete: function() {
                                            $("#NO_CONT").val('');
