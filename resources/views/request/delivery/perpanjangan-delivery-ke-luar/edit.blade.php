...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit Perpanjangan</li>
        </ol>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="border rounded my-3">
                    <form id="dataCont">
                        ...
                        <div class="p-3">
                            <div class="row">
                                <div class="col-md-2 py-2">
                                    <label for="tb-fname">Nomor Request: </label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" name="NO_REQ_NEW" id="NO_REQ_NEW" class="form-control" value="{{ $data['row_request']->no_request}}" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2 py-2">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="NO_REQ" id="NO_REQ" class="form-control" value="{{ $data['no_req'] ?? ''}}" readonly>
                                </div>
                                <div class="col-md-2 py-2">
                        ...
                        @if ($data['row_count']->jumlah == 0)
                        <b class="text-danger"><i>Semua container telah diperpanjang</i></b>
                        @endif
...
<script>
    $(document).ready(function() {
        $('#container-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{!! route("uster.new_request.delivery.perpanjangan_delivery_luar.editcontlist") !!}',
                type: 'GET',
                data: function(d) {
                    d.noReq = $('#NO_REQ').val();
                }
            ...
            initComplete: function() {
                ...
                $('#button_save').html('<button type="button" onclick="simpanarea()" value="Save" class="btn btn-info">Update Data</button>');
                $('#total').val(totalRows);
            }
        });
    });
    ...
    function simpanarea() {
        ...
        $.ajax({
            url: '{!! route("uster.new_request.delivery.perpanjangan_delivery_luar.editperpanjangandelivery") !!}', // Ganti dengan URL yang sesuai
