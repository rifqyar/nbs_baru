...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor">View Perpanjangan Stripping</h3>
            <ol class="breadcrumb">
                                        ...
                                        <tbody id="data-contlist-view">
                                            ...
                                            @foreach ($container->row_list as $cnt)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if($overview)
                                                            <input type="text" class="form-control" name="tgl_perp[]" value="{{\Carbon\Carbon::parse($cnt->end_stack_pnkn)->format('Y-m-d')}}" readonly>
                                                        @else
                                                            <input type="date" class="form-control" name="tgl_perp[]">
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (!$overview)
                                                            <button class="btn btn-sm btn-info" onclick="info_lapangan(`{{$cnt->no_container}}`)"><i class="fa fa-info-circle"></i> Info</button>
                                                        @endif
                                                    </td>
                                                </tr>
                                                @php
                                                ...
                                                <tr>
                                                    <td colspan="8">
                                                        <div class="d-flex align-items-center justify-content-center">
                                                            <button class="btn btn-success" onclick="simpanarea();"> <i class="fa fa-save mr-2"></i> Simpan Perpanjangan Stripping</button>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tfoot>
