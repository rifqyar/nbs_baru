...
@section('content')
    ...
    {{-- @if(Session::has("notifCekPaid"))
        <div class="alert closeable alert-danger fade show" role="alert">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor">Perencanaan Stripping</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">New Request</a></li>
                <li class="breadcrumb-item">Stripping</li>
                <li class="breadcrumb-item active">Perencanaan Stripping</li>
            </ol>
        </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="col-12 col-md-12">
                                            <div class="form-group m-b-40">
                                                <label for="no_req">No. Rencana Stripping</label>
                            ...
                            <div class="row py-2">
                                <div class="col-md-12">
                                    <div class="alert alert-danger" role="alert">
                                        <h4 class="mb-0 text-center">
                                            <span class="text-size-5">Terdapat {{ $jumlah_req }} request yang belum di
                                                approve</span>
                                            <i class="fas fa-exclamation-circle"></i>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="alert alert-primary" role="alert">
                                        <h4 class="mb-0 text-center">
                                            Total request yang telah di approve tanggal {{ \Carbon\Carbon::now()->translatedFormat('d F Y') }} = {{ $total_req }}
                                            request ({{ $total_cont }} box)
                                            <i class="fas fa-exclamation-circle"></i>
                                        </h4>
                                    </div>
