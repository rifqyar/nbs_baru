                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="javascript:void(0)" id="request-header" class="form-horizontal m-t-20" novalidate>
                                ...
                                <input type="hidden" id="PENUMPUKAN" name="penumpukan" class="kdemkl" placeholder="{{$request->row_request->nama_penumpuk}}"/>
                                ...
                                <input type="hidden" name="id_consignee" id="ID_CONSIGNEE" value="{{$request->row_request->kd_consignee}}">
                                ...
                                <div class="row justify-content-center align-items-start">
                                    <div class="col-md-6 col-12 mb-2">
                                        ...
                                        <input type="text" name="no_req" class="form-control" readonly id="no_req" value="{{$request->row_request->no_request_plan}}">
                                    </div>
                                    <div class="col-md-6 col-12 mb-2">
                                        <label for="no_req2">&nbsp;</label>
                                        <input type="text" name="no_req2" class="form-control" readonly id="no_req2" value="{{$request->row_request->o_reqnbs}}">
                                    </div>
                                    <div class="col-md-6 col-12 mb-2">
                                        <label for="consignee">Penerima / Consignee <small class="text-danger">*</small></label>
                                        <input type="text" name="consignee" id="CONSIGNEE" class="form-control" value="{{$request->row_request->nama_pemilik}}" required>
                                        <div class="invalid-feedback"> Mohon pilih Penerima / Consignee</div>
                                    </div>
                                    <div class="col-md-6 col-12 mb-2">
                                        <label for="consignee_personal">Nama Personal Consignee</label>
                                        <input type="text" id="consignee_personal" name="consignee_personal" class="form-control" value="{{$request->row_request->consignee_personal}}">
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12 mb-2">
                                        ...
                                        <div class="row align-items-start">
                                            <div class="col-md-5 col-12">
                                                <input id="NM_KAPAL" name="nm_kapal" type="text" class="form-control" value="{{$request->row_request->o_vessel}}" />
                                            </div>
                                            <div class="col-md-2 col-12">
                                                <input type="text" id="VOYAGE_IN" class="form-control" name="voyage_in" value="{{$request->row_request->o_voyin}}"/>
                                            </div>
                                            <div class="col-md-2 col-12">
                                                <input type="text" id="VOYAGE_OUT" class="form-control" name="voyage_out" value="{{$request->row_request->o_voyout}}"/>
                                            </div>
                                            <div class="col-md-3 col-12">
                                                <input type="text" id="IDVSB" class="form-control" name="IDVSB" value="{{$request->row_request->o_idvsb}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 mb-2">
                                        <div class="row align-items-start">
                                            <div class="col-md-6 col-12">
                                                ...
                                                <input type="text" class="form-control" id="no_do" name="no_do"  value="{{$request->row_request->no_do}}"/>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <label for="no_bl"> Nomor B.L</label>
                                                <input type="text" class="form-control" id="no_bl" name="no_bl"  value="{{$request->row_request->no_bl}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12 mb-2">
                                        <label for="no_sppb">Nomor SPPB</label>
                                        <input type="text" id="no_sppb" class="form-control" name="no_sppb" value="{{$request->row_request->no_sppb}}"  />
                                    </div>
                                    <div class="col-md-4 col-12 mb-2">
                                        <label for="tgl_sppb">Tanggal SPPB</label>
                                        <input type="text" id="tgl_sppb" class="form-control" name="tgl_sppb" value="{{$request->row_request->tgl_sppb}}"  />
                                    </div>
                                    <div class="col-md-4 col-12 mb-2">
                                    ...
                                    <div class="col-md-12 col-12 mb-2">
                                        ...
                                        <input type="text" name="keterangan" class="form-control" id="keterangan" value="{{$request->row_request->keterangan}}">
                                    </div>
                                </div>
                                <div class="d-flex justify-content-end mt-3">
                                    <a href="{{route('uster.new_request.stripping.stripping_plan.awal_tpk')}}" class="btn btn-warning mr-3"> <i class="mdi mdi-chevron-left"></i> Kembali</a>
                                ...
                                <table class="display nowrap table" czllspacing="0" width="100%" id="list-cont-table">
                                    <thead >
                                        <tr>
                                            ...
                                            <th class="text-center" scope="col">Tgl. Bonkar</th>
                                        ...
                                        @foreach ($container as $cnt)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{$cnt->remark}}
                                                    @if (Session::get('id_group') == 'J' || Session::get('id_group') == 'K')
                                                        <input type="text" name="remarks_{{$i}}" class="form-control" value="{{$cnt->remark}}">
                                                    @elseif(Session::get('id_group') == '6')
                                                        {{$cnt->remark}}
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-danger" onclick="delCont(`{{$cnt->no_container}}`)">Hapus</button>
                                                </td>
                                            </tr>
                                            @php
                                                $i++;
