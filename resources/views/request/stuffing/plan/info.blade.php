<table border=1 width="100%" align="center">
    ...
    <tr align="center">
        <td colspan="3" align="center" valign="middle" class="grid-cell" style="font-size:9pt"> Container di Blok
            Stuffing :</td>
        <td colspan="3" align="center" valign="middle" class="grid-cell" style="font-size:9pt">{{$row_cap[0]->stf}}</td>
    </tr>
</table>
